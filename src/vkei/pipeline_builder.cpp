...
namespace mdsm::vkei
{
    PipelineBuilder::PipelineCreationFailed::PipelineCreationFailed(const VkResult result)
    :
        runtime_error {
            std::format(
                "Pipeline creation failed with error {}!",
    ...
    void PipelineBuilder::enableAddictiveBlending()
    {
    ...
    void PipelineBuilder::enableAlphablendBlending()
    {
        color_blend_attachment.colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT;
        color_blend_attachment.blendEnable = VK_TRUE;
        color_blend_attachment.srcColorBlendFactor = VK_BLEND_FACTOR_SRC_ALPHA;
